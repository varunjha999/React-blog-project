...
const Details = (props) => {
  const [details, setDetails] = useState([
    {
      id: 1,
      title: "Kisi ka bhai kisi ka jaan box office ",
      img: "https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1atwqw.img?w=1920&h=1080&q=60&m=2&f=jpg ",
      category: "Bollywood",
      description:
        "Kisi Ka Bhai Kisi Ki Jaan is a Hindi action comedy-drama film directed by Farhad Samji. It stars Salman Khan and Pooja Hegde in the lead role. KKBKKJ, which is billed as a mass-market family entertainer, is a remake of the Ajith-starrer Veeram. The South film was a box office success in its time. The Hindi version, though, seems to have run out its course at the box office. After crossing the Rs 100-crore mark, KKBKKJ continues slipping further.",
    },
    {
      id: 51,
    ...
    },
    {
      id: 2,
      title:
        "Met Gala 2023: Alia Bhatt's Mumbai To The Met Look Is This Celeb Stylist's Brainchild",
      img: "https://c.ndtvimg.com/2023-05/qmrd889_alia-_625x300_02_May_23.jpg",
      category: "Bollywood",
      description:
    ...
    {
      id: 11,
      title: "Citadel Spies Priyanka Chopra And Richard Madden Now Take Over Los Angeles. See Pics",
      img: "https://c.ndtvimg.com/2023-04/r610s8to_priyanka-chopra_625x300_26_April_23.jpg",
      category: "Hollywood",
      description:
    ...
    {
      id: 12,
      title: "Hey Jr NTR, Guardians Of The Galaxy Director James Gunn Wants To Work With You",
      img: "https://c.ndtvimg.com/2023-04/5llu6ov_jr-ntr-_625x300_26_April_23.jpg",
      category: "Hollywood",
      description:
        " Dear Jr NTR fans, we have some fantastic news in store for you. Guardians of the Galaxy director James Gunn has revealed that he “would love to work” with the RRR actor and introduce him to the Marvel Universe. ",
    },
    {
      id: 13,
      title: "Thor",
    ...
    {
      id: 21,
      title: "UK chip giant Arm files for blockbuster US share listing",
      img: "https://ichef.bbci.co.uk/news/976/cpsprodpb/13BD5/production/_113835808_armchip.jpg.webp",
      category: "Technology",
      description:
    ...
    },
    {
      ...
      img: "https://ichef.bbci.co.uk/news/976/cpsprodpb/9A6E/production/_129543593_gettyimages-1251704940.jpg.webp",
      category: "Technology",
      description:
        "Access to the ChatGPT chatbot has been restored in Italy.It was banned by the Italian data-protection authority at the start of April over privacy concerns.",
    },
    {
      id: 63,
    ...
    {
      id: 31,
      title: "Fitness alert: Foolproof tips that will help you master the plank",
      img: "https://images.indianexpress.com/2023/04/planktips_Getty1200.jpg?w=640",
      category: "Fitness",
      description:
        "Plank is a very common core-strengthening exercise in which the practitioner must hold their body parallel to the ground in a position similar to a push-up (with the weight divided between the toes and arms) for as much time as they deem comfortable. However, it is extremely important to do the exercise with proper form to avoid any injuries, especially for beginners. Running is a method of terrestrial locomotion allowing humans and other animals to move rapidly on foot. Running is a type of gait characterized by an aerial phase in which all feet are above the ground (though there are exceptions).[1] This is in contrast to walking, where one foot is always in contact with the ground, the legs are kept mostly straight and the center of gravity vaults over the stance leg or legs in an inverted pendulum fashion.[2] A feature of a running body from the viewpoint of spring-mass mechanics is that changes in kinetic and potential energy within a stride occur simultaneously, with energy storage accomplished by springy tendons and passive muscle elasticity.[3] The term running can refer to any of a variety of speeds ranging from jogging to sprinting.Running in humans is associated with improved health and life expectancy.[4]",
    },
    {
      id: 32,
      title: "Shilpa Shetty’s ‘different from the usual’ workout will help strengthen your core",
      img: "https://images.indianexpress.com/2023/01/Shilpa-Shetty-belly-dancing-1.jpg?w=640",
      category: "Fitness",
      description:
        "Shilpa Shetty Kundra is a wellness crusader and, as such, regularly shares inspirational workouts, yoga, and healthy food recipe videos on Instagram. In a similar vein, the actor recently shared a glimpse of her belly dance workout routine, which was a great example of mixing exercising with fun.Skateboarding is an action sport originating in the United States that involves riding and performing tricks using a skateboard, as well as a recreational activity, an art form, an entertainment industry job, and a method of transportation.[1][2] Skateboarding has been shaped and influenced by many skateboarders throughout the years. A 2009 report found that the skateboarding market is worth an estimated $4.8 billion in annual revenue, with 11.08 million active skateboarders in the world.[3] In 2016, it was announced that skateboarding would be represented at the 2020 Summer Olympics in Tokyo, for both male and female teams.[4]",
    },
    {
      id: 33,
      title: " Swimming ",
    ...
    {
      id: 41,
      title: "One Pot Honey Lemon Chicken Recipe",
      img: "https://c.ndtvimg.com/2023-02/06dq2j1g_chicken-curry_625x300_20_February_23.png",
      category: "Food",
      description:
        "One Pot Honey Lemon Chicken Recipe: Honey lemon chicken is a tasty pan-fried chicken recipe that you can make in 20 minutes. This dish is packed with the sweetness of honey, the tanginess of lemon, and the heavy aroma of fresh spices.Tandoori chicken is a South Asian dish of chicken marinated in yogurt and spices and roasted in a tandoor, a cylindrical clay oven. The dish is now popular world-wide. The modern form of the dish was popularized by the Moti Mahal restaurant in New Delhi in the late 1940s.",
    },
    {
      id: 42,
